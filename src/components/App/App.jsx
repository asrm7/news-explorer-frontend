  ...
  return (
    <CurrentUserContext.Provider value={currentUser}>
      <div className="App">
        <Routes>
          <Route path="/" element={
            <>
              ...
              {results && <NewsCardList cards={cards} keyword={keyword} hover="Entre para salvar artigos" loggedIn={loggedIn} />}
              {noResults && <NoResults />}
              {loading && <Preloader />}
          ...
          <Route path="/saved-news" element={
            <ProtectedRoute loggedIn={loggedIn}>
              <SaveNews headerClick={logout} singInDirect={openSignIn} />
            </ProtectedRoute>
          } />
        ...
        <SignInPopup signInOpen={signIn} onClose={closeAll} handleSubmit={signInSubmit} toggle={openSignUp} />
        <SignUpPopup signUpOpen={signUp} onClose={closeAll} handleSubmit={signUpSubmit} toggle={openSignIn} />
      </div>
