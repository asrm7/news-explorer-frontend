  ...
  return (
    <section className="cards">
      <div className="cards__container">
        <h2 className={`cards__container_title ${props.savedArticles ? 'hidden' : ''}`}>Resultados encontrados</h2>
      ...
      <button type="button" onClick={() => setCount((prevCount) => prevCount + 3)} className={`cards__btn ${isButtonVisible ? '' : 'hidden'}`}>Mostrar mais</button>
    </section>
  );
};
